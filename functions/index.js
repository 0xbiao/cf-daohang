    ...
    <div class="max-w-4xl mx-auto text-center relative z-10 ${themeClass} py-8">
      ...
      <div class="relative max-w-xl mx-auto">
        ...
        <div class="relative flex items-center">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 absolute left-4 ${searchIconClass}" style="top: 50%; transform: translateY(-50%); pointer-events: none;" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
          <button type="button" class="web-search-btn absolute right-2 p-2 bg-primary-500 hover:bg-primary-600 text-white rounded-xl transition-colors shadow-sm cursor-pointer z-10" style="top: 50%; transform: translateY(-50%);">
